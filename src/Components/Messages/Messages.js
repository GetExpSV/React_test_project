...
const Messages = (props) => {
    ...
    let dialogsArray = props.personData.map(data => <DialogItem name={data.name} id={data.id}/>);
    let messagesArray = props.messagesData.map(data => <Dialog message={data.message}/>);
